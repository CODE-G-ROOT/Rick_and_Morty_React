	...
	return (
		<>
			{Object.keys(data).map((key) => (
				<div
					key={key}
					className='rounded-2xl h-[7rem] w-[8rem] flex flex-col gap-3 p-4 border-solid border-1.5 bg-gray/5 shadow-lg justify-around'
				>
...
const Block_Card = () => {
	return (
		<>
			<div className='flex gap-10 xl:gap-5 h-fit sm:w-full sm:justify-evenly'>
